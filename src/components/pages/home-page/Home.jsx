  ...
  return (
    ...
    <>
     ...
     >
      ...
      <div className="bg-[url('/assets/hero.png')] w-full sm:h-[300px] ">
      </div>
      ...
      <div className="w-full flex flex-row ">
        <div className='grid grid-cols-1 bg-slate-200 sm:grid-cols-2'>
          <div>
          ...
          <div className="bg-[url('/assets/team.png')]">
          </div>
        </div>
      </div>
      ...
      <div className='flex w-full sm:h-[377px]'>
        <div className="container" >
          <div className='grid grid-cols-1 lg:grid-cols-2'>

            <div className="sm:w-[370px] sm:h-[228px] place-self-center">
            <img  src={mobile} alt={"Phone"}/>
            </div>

            <div className="sm:w-[800px] sm:h-[228px]">
     ...
     <div className="w-full sm:h-[304px] bg-blue-900 grid">
       <div className='sm:h-[154px] place-self-center text-center'>
