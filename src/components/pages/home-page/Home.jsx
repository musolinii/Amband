    ...
    <>
     ...
     >
      ...
      <div className='grid grid-cols-1'>
        <div className="sm:bg-[url('/assets/hero.png')] w-full sm:h-[300px] ">
        </div>
      </div>

      <div className="w-full sm:h-[325px] grid ">

        <div className=" w-full sm:h-[135px] place-self-center box-border ">
          <h4 className='text-[28px] font-bold text-center'>WELCOME TO AMBAND</h4>
          <p className="text-[14px] sm:h-[50px] box-border text-center  mt-[30px] leading-relaxed">We are an innovative and dynamic information technology company that prides itself by offering bespoke and “out of the box” IT related solutions to our clients.</p>
        </div>
      </ div>

      <div className="w-full sm:h-[511px] grid grid-cols-1 sm:grid-cols-2">

       <div className="bg-slate-200  sm:h-[511px] ">

         <div className="sm:h-[360px] mt-[80px] ml-[80px]">

           <h4 className="text-[28px] font-bold mb-[50px]">WHO WE ARE </h4>

           <h4 className="text-[28px] font-bold mb-[30px]">Our philosophy</h4>

           <p className="text-[14px] leading-relaxed">We have a very good track record working with satisfied clients all around the globe. Up to now, no client was left unsatisfied. This is because we make sure that in every project partnership opportunity handed to us, requirements are met, all modifications are worked out, arising problems are diagnosed and given solution at the soonest possible time and continuous maintenance and updates are never forgotten.</p><br />
           <p className="text-[14px] leading-relaxed">We can do all these because of the human and technology resources that we have. Amband gives you products and services that are worthy of every amount spent.</p>
        </div>
      ...
      <div className="sm:my-[100px] sm:mx-[220px] h-[85px]">
       <div className='w-full sm:h-[85px] '>
         <h4 className='text-[28px] font-bold text-center py-[20px]'>OUR WORK</h4>
       </div>
      </div>


     <div className="grid grid-cols-1 sm:grid-cols-2">
       <div className='sm:w-[550px] h-full grid gap-2 text-[14px] leading-relaxed'>
         <div className='sm:w-[534px] sm:h-[170px] mx-[20px]'>
           <h5 className='font-bold mb-[20px]'>Our Services</h5>
           <p className='mb-[30px]'>Amband offers the following services to our clients; Software and website development, ICT consultancy, ICT support and maintenance, Monitoring and Evaluation, IS audit and IT governance.</p>
           <Link to="/services" className='text-blue-500'>Read More</Link>
         </div>
       ...
       <div className='sm:w-[600px] h-full grid gap-2 text-[14px] leading-relaxed'>
         <div className='sm:w-[534px] sm:h-[170px] mx-[20px]'>
           <h5 className='font-bold mb-[20px]'>Solutions</h5>
           <p className='mb-[30px]'>Amband offers the following solutions to our clients; Asset management system, Hospital Management Information Systems, Academic and student management systems.</p>
           <Link to="/solutions" className='text-blue-500'>Read More</Link>
         </div>
         <div className='sm:w-[534px] sm:h-[250px] mx-[20px] '>
           <h5 className='font-bold mb-[20px]'>RFID</h5>
             <p>Amband offers the following RFID solutions;</p>
               <ul className='mb-[30px]'>
                 <li>Supply chain management</li>
     ...
     <div className="w-full sm:h-[377px] grid" >
        <div className="self-center sm:w-[1200px] sm:h-[228px] sm:ml-[200px] grid grid-cols-1 sm:grid-cols-2 gap-y-0">
          <div className="sm:w-[370px] sm:h-[228px]">
          <img  src={mobile} alt={"Phone"}/>
          </div>
          <div className="sm:w-[800px] sm:h-[228px] ml-[20px]">
            <h4 className='text-[28px] font-bold mb-[30px]'>MOBILE APP DEVELOPMENT</h4>
            <p className="text-[14px] leading-relaxed mr-[30px]">Leverage our mobile application development teams to develop novel apps, which can help you to scale-up your businesses.</p>
          </div>
        </div>

     </div>

     <div className="w-full sm:h-[304px] bg-blue-900 grid">
       <div className='sm:w-[1170px] sm:h-[154px] sm:ml-[200px] place-self-center text-center'>
         <h2 className='text-[34px] text-white mb-[20px]'>Impressed With Our Services  ?</h2>
         <p className='text-[14px] text-white'>Leave us a message or request for a services ?</p>
         <button onClick={handleOpen} className='bg-white text-black px-[20px] py-[10px] mt-[20px] text-sm rounded hover:bg-slate-500 transition'>Contact Us</button>
