      ...
      <div className="w-[1170px] h-full grid gap-2 mb-[30px]">
        ...
        <div className="w-full h-[300px] flex flex-row justify-between">
          ...
          <div className="w-[530px] h-[250px] text-right">
            ...
            <Link to="/wsd" className="place-self-center">
        ...
        <div className="w-full h-[300px] flex flex-row justify-between">
          ...
          <div className="w-[530px] h-[250px] text-left">
            ...
            <Link to="/ics" className="place-self-center">
              <button className="w-[100px] h-[40px] bg-blue-800 text-white rounded-md">Read More</button>
            </Link>
            </div>
        ...
        <div className="w-full h-[300px] flex flex-row justify-between">
          ...
          <div className="w-[530px] h-[250px] text-right">
            ...
            <Link to="/bpr" className="place-self-center">
              <button className="w-[100px] h-[40px] bg-blue-800 text-white rounded-md">Read More</button>
            </Link>    
            </div>
        ...
        <div className="w-full h-[300px] flex flex-row justify-between">
          ...
          <div className="w-[530px] h-[250px] text-left">
            ...
            <Link to="/it-support" className="place-self-center">
              <button className="w-[100px] h-[40px] bg-blue-800 text-white rounded-md">Read More</button>
            </Link>
          </div>
        ...
        <div className="w-full h-[300px] flex flex-row justify-between">
          ...
          <div className="w-[530px] h-[250px] text-right">
            ...
            <Link to="/iag" className="place-self-center">
              <button className="w-[100px] h-[40px] bg-blue-800 text-white rounded-md">Read More</button>
            </Link>
            </div>
        ...
        <div className="w-full h-[300px] flex flex-row justify-between">
          ...
          <div className="w-[530px] h-[250px] text-left">
            ...
            <Link to="/cyber-security" className="place-self-center">
              <button className="w-[100px] h-[40px] bg-blue-800 text-white rounded-md">Read More</button>
            </Link>          </div>
