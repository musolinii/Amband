  ...
  return (
    <>
      <div className="bg-slate-800 w-full h-[170px] grid ">
        ...
        <p className='place-self-center'>RFID Solutions</p>
      ...
      <div className='grid md:grid-cols-4 gap-[10px] justify-items-center'>
          <div className="bg-black w-1/4 h-[80px] m-[5px]    ">
          </div>
